...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_analysis_results_domain'), 'analysis_results', ['domain'], unique=False)
    ...
    op.create_index(op.f('ix_health_snapshots_service'), 'health_snapshots', ['service'], unique=False)
    ...
    op.create_index(op.f('ix_incidents_failure_pattern'), 'incidents', ['failure_pattern'], unique=False)
    ...
    op.create_table('auto_heal_actions',
    sa.Column('id', sa.UUID(), nullable=False),
